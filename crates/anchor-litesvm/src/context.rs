...
use crate::anchor_instruction_builder::AnchorInstructionBuilder;
...
/// native Anchor instruction building without RPC overhead.
...
impl AnchorContext {
    ...
    /// Create a native Anchor instruction builder.
    ///
    /// This provides a lightweight way to build instructions using types
    /// generated by `anchor_lang::declare_program!` without RPC overhead.
    ///
    /// # Example
    /// ```ignore
    ...
    ///     .build();
    /// ```
    pub fn instruction(&self) -> AnchorInstructionBuilder {
        AnchorInstructionBuilder::new(self.program_id)
    }
